...
<body class="min-h-screen bg-zinc-50 dark:bg-zinc-900">
    ...
    <flux:sidebar sticky stashable class="bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.item icon="credit-card" href="{{ route('admin.orders.index') }}" :current="request()->routeIs('admin.orders.*')">Pesanan</flux:navlist.item>
            ...
            <flux:navlist.item icon="cog-8-tooth" href="{{ route('admin.settings.edit') }}" :current="request()->routeIs('admin.settings.*')">Pengaturan</flux:navlist.item>
        </flux:navlist>
